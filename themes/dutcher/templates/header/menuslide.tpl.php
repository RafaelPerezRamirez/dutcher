<div class="second-menu animationMenu">
    <div class="absolute color_white avenir-normal pointer button-close">
        X
    </div>
    <div class="absolute centrar_total text-center">
        <div class="new-foto-instagram"></div>
        <div class="color_white avenir-bold medium dutcher-menu">
            DUTCHER MÉXICO 2017
        </div>
        <hr>
